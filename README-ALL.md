# Attenuator Controller — Gesamtdokumentation (ESP32 + Pico)

> **Konsolidierte README.** Diese Datei fasst alle einzelnen READMEs des Projekts
> zusammen und wurde gegen den Quellcode geprüft (Stand: 2026-08-17,
> Firmware-Version **0.51**, siehe [shared/version.h](shared/version.h)).
> Die ursprünglichen READMEs bleiben unverändert erhalten. Abweichungen zwischen
> altem README-Text und dem tatsächlichen Code sind im Abschnitt
> [Korrekturen gegenüber den alten READMEs](#korrekturen-gegenüber-den-alten-readmes)
> dokumentiert.

Steuerungssystem für HF-Attenuatoren mit bistabilen Relais. Zwei unabhängig oder
gemeinsam betreibbare Module.

Quell-READMEs, die hier zusammengeführt sind:
- [README.md](README.md) — Projektübersicht (Root)
- [README copy.md](README%20copy.md) — ältere Fassung der Projektübersicht
- [esp32/README.md](esp32/README.md) — ESP32 Touch-Controller
- [pico/README.md](pico/README.md) — Pico Relais-/Drehgeber-Controller
- [esp32/docu/esp32-display/Readme.md](esp32/docu/esp32-display/Readme.md) — Hersteller-Doku des CYD-Displays
