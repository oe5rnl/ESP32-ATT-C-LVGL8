 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --bpp 4 --size 72 --font .pio/libdeps/cyd/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --range 0x20,0x30-0x39 --format lvgl --output src/lv_font_digits_72.c --lv-include lvgl.h --no-compress
 ******************************************************************************/
